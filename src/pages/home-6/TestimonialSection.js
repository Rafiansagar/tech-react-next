...
// Testimonial Images
import testiMainimg from '../../../public/assets/img/testimonial/testimonial-3.png';
...
function Testimonial() {
    ...
    return (
        <React.Fragment>
            <div className="rs-testimonial main-home style4 modify1 sec-bg pt-120 pb-120 md-pt-80 md-pb-80">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-6 modify-gap">
                            <SectionTitle
