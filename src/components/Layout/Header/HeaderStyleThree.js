							...
							<div className="row align-items-center">
								<div className="col-lg-3">
									<div className="logo-part hidden-md">
										<Link href="/" as="/">
											<a>
												<img className="normal-logo" src={require("../../../../public/assets/img/logo/white-logo.png")} alt="" />
												<img className="sticky-logo" src={require("../../../../public/assets/img/logo/logo.png")} alt="" />
											</a>
										</Link>
									</div>
								</div>
